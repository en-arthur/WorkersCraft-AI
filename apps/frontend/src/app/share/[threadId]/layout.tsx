...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | WorkersCraft AI',
    description: 'Replay this Worker conversation on WorkersCraft AI',
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_URL}/share/${threadId}`,
    },
    openGraph: {
      title: 'Shared Conversation | WorkersCraft AI',
      description: 'Replay this Digital Worker conversation on WorkersCraft AI',
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | WorkersCraft AI';
    const description =
      projectData.description ||
      'Replay this Digital Worker conversation on WorkersCraft AI';
