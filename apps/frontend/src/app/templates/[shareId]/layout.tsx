...
export async function generateMetadata({ params }: { params: Promise<{ shareId: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    const title = `${template.name} - AI Worker Template | WorkersCraft AI`;
    ...
    return {
      title: 'AI Digital Worker Template | WorkersCraft AI',
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'WorkersCraft AI Digital Worker Template',
          }
        ],
      },
    };
