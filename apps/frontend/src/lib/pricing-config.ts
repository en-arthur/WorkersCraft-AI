...
export const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      '1 concurrent run',
      '10 Total Chats',
      'Basic Mode - Core WorkersCraft AI experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create WorkersCraft AI Digital Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create WorkersCraft AI Digital Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create WorkersCraft AI Digital Workers with custom Knowledge, Tools & Integrations',
