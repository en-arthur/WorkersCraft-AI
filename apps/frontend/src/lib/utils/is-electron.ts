...
const ELECTRON_PROTOCOL = 'workerscraft';
...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/WorkersCraft-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://workerscraft.ai/auth/callback)
 * - Electron: returns the custom protocol URL (workerscraft://auth/callback)
 */
